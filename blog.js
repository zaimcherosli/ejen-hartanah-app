...
function getRequestedSlug() {
  ...
  if (path.startsWith('/blog/') && path.length > 6) {
    return decodeURIComponent(path.replace('/blog/', '').replace(//$/, ''));
  }
  ...
  if (container) {
    container.innerHTML = `
      ...
      <div class="article-cta-box">
        ...
        <a href="${waConsultUrl}" target="_blank" class="btn-primary" style="background: #25d366; color: white; display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; border-radius: 50px; font-weight: 800; text-decoration: none;">
          <span>💬</span> Dapatkan Khidmat Nasihat Percuma
        </a>
      </div>
      ...
      <div class="article-share-bar">
        ...
        <a href="${waShareUrl}" target="_blank" class="share-btn" style="background: #25d366;">WhatsApp</a>
