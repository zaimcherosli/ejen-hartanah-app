...
window.CEM_SYSTEM = {
  ...
  ENV: 'Production (Cloudflare Pages + WanAzemi Guarantee + Photo Lightbox Zoom & Watermark-Free Agent Uploads)',
  PWA_VERSION: 'cem-pwa-v53'
};
...
window.showSystemInfo = function() {
  const infoMsg = 
    ...
    `• Monitoring     : Sentry Real-Time Error Tracking Active\n` +
...
window.testSentryError = function() {
  if (window.Sentry) {
    ...
    alert("Sentry sedang dimuatkan, sila cuba sebentar lagi.");
  }
};
